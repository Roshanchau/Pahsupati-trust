...
const Navbar = () => {
  ...
  return (
    <>
      <header>
        <nav
          className={`flex flex-row items-center sm:justify-between px-1
         t   w-full
            z-50
            fixed
            top-0
  ...
  `}
        >
          ...
          <div>
            <img
              className={`transition duration h-[100px] w-[full] sm:h-30
            ${showBackgroud ? "sm:h-[90px] h-[100px]" : ""}`}
        ...
        {/* <aside
          id="default-sidebar"
          className="fixed sm:hidden my-0 top-20 z-40 w-50 h-full transition-transform duration-1000 translate-x-0 "
          aria-label="Sidebar"
        >
